...
public class Alien extends Critter {
	public boolean boss;
	public Flower player;  //**For testing purposes, change Player to Flower.
	public int steps;
	/* Commented for testing purposes:
	...
	*/
    ...
    public Alien(boolean canPlaceRocks, Flower player1) {  //**For testing purposes, change Player to Flower.
	...
	public void processActors(ArrayList<Actor> actors) {
		...
		for (Actor a : actors) {
            if (a instanceof Flower) {  //**For testing purposes, change Player to Flower.
            	removeSelfFromGrid();
            	/* Commented for testing purposes:
